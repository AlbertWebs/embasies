...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
                  ...
                  <nav class="nav">
                     <ul class="nav-list">
                        ...
                        <li class="nav-item">
                           ...
                           <div class="sub-nav">
                              <ul class="nav-submenu">
                                 <li><a title='Econet Wireless' href='company/econet-wireless.html' >Econet Wireless</a></li>
                                 <li><a title='Cassava Technologies' href='company/cassava-technologies.html' >Cassava Technologies</a></li>
                              </ul>
                           </div>
                        </li>
                        <li class="nav-item">
      ...
      <div class="recent-news_press-release-area">
         ...
         <div class="container-area1 recentpress-releases">
            ...
            <div class="clearfix h40"></div>
            <div class="text-center"><a class="allbt" href="press-release.html">All press releases</a></div>
            <div class="clearfix"></div>
         </div>
         <div class="clearfix"></div>
      </div>
