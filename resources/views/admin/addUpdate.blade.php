              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Update')}}" enctype="multipart/form-data">

                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="" placeholder="e.g Payment Successful " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="limiter" class="control-label col-lg-4">Update</label>
